---
name: content-hub
description: 多平台内容聚合抓取工具（支持 YouTube、Bilibili、小红书的搜索、视频字幕获取）
---
...
**搜索完成一定要进行内容获取** 获取到三个平台的搜索结果后，你可以观察内容列表，选择其中更受欢迎的10%的内容进行抓取。使用搜索与发现列表中的URL即可进行抓取，工具抓取的结果的最后一行是字幕文件所在地址，使用字幕内容来参与大模型的内容生成
